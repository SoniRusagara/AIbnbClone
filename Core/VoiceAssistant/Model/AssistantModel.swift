...
@Observable
class AssistantModel: NSObject, AVAudioRecorderDelegate, AVAudioPlayerDelegate {
    
    let client = OpenAIClient(apiKey: "YOUR_API_KEY") // update key when making API request
    ...
    // func to enable user to cancel audio
